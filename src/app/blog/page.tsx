    ...
    return (
      <div className="container mx-auto max-w-6xl p-6">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Stories and insights</p>
        </div>
    ...
    <div className="container mx-auto max-w-6xl p-6">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Stories, insights, and thoughts from HIMAFI ITB
        </p>
      </div>
      ...
      {posts && posts.length > 0 ? (
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-muted-foreground">
              Check back later for the latest stories and insights.
            </p>
          </CardContent>
        </Card>
      )}
