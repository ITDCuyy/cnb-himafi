...
export default function BlogManagePage() {
  ...
  // Filter for blog posts only and apply search/status filters
  const blogPosts = posts?.filter((post) => {
    ...
    return isBlog && matchesSearch && matchesStatus;
  });
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              View and manage your blog posts and drafts
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <Link href="/drafts?type=blog">
          ...
          <CardContent>
            ...
            <p className="mb-4 text-muted-foreground">
              {searchQuery
                ...
                : statusFilter === "draft"
                  ? "You don't have any blog drafts yet."
